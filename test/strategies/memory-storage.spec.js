...
const {NOT_FOUND, MemoryStorageCapsule} = require('../../src');

describe('memory-strategy', () => {

  it('should store and retrieve information', async () => {
    const capsule = new MemoryStorageCapsule();
  ...
  it('should optionally pass a scope in constructor', async () => {
    const capsule = new MemoryStorageCapsule({namespace: 'wix', scope: 'scope'});
    await capsule.setItem('shahata', 123);
